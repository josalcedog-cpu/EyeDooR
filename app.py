...
CAMERA_CAPTURE_URL = "http://10.154.150.123:81/capture"

# Importante: Capturar Foto, no cambiar nada
@app.route("/capturar", methods=["GET"])
def capturar_foto():
    print("\n--- INICIANDO DIAGNÓSTICO DE CAPTURA ---")
    try:
        # 1. aca verifica el url por completo
        ...
        if response.status_code == 200 and response.content:
            ...
            # aca intentamos subirlo a Firebase
            try:
